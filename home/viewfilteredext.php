...
<head>
   ...
   <!-- ExtJS -->
    ...
    <!-- Example -->
    <link rel="stylesheet" type="text/css" href="../plugins/examples/ux/grid/css/GridFilters.css" />
    <link rel="stylesheet" type="text/css" href="../plugins/examples/ux/grid/css/RangeMenu.css" />
    <script type="text/javascript" src="../plugins/examples/grid-filtering/grid-filter-local.js"></script>
</head>
<body>
