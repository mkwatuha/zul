...
var formPanel3 = Ext.create('Ext.form.Panel', {
		   ...
		   
  {
		   ...
		   items:[
		   {
					...
					margin: '0 5 5 0',
					handler:function(){
					//showGeneralAccts($contacts);
					var perid=Ext.getCmp('myaccountpid').getValue();
					var acc=Ext.getCmp('clandlord').getValue();
					fillLandlordStatement(acc,53,perid,'Y');
					//showGeneralAccts()
...
var closebtn= Ext.get('close-btn');
    ...
    extend: 'Ext.data.Model',
	fields:[{name:'housinglandlord_id'},{name:'housinglandlord_name'},{name:'person_name'},{name:'contract_day'},{name:'month_name'},{name:'contract_year'},{name:'term_period'},{name:'term_months'},{name:'commission'},{name:'commission_alternative'},{name:'excess_amount'},{name:'payment_day'},{name:'property'},{name:'contract_dated'},{name:'rentperiod_name'}
	,{name:'person_fullname'},{name:'person_id'}]
	});
  ...
  //////////
    var grid = Ext.create('Ext.grid.Panel', {
		...
		Ext.getCmp('personreft').setValue(record.get('housinglandlord_name'));
		Ext.getCmp('contractdatet').setValue(record.get('period_startdate'));
		var acc=record.get('housinglandlord_name');
		fillLandlordStatement(acc,53,record.get('person_id'),'Y');
	...
	/*{name:'housinglandlord_id'},{name:'housinglandlord_name'},{name:'person_name'},{name:'contract_day'},{name:'month_name'},{name:'contract_year'},{name:'term_period'},{name:'term_months'},{name:'commission'},{name:'commission_alternative'},{name:'excess_amount'},{name:'payment_day'},{name:'property'},{name:'contract_dated'},{name:'rentperiod_name'},{name:'person_fullname'}]
	  ...
	  var empname=record.get('person_fullname');
		...
		Ext.getCmp('contractdatet').setValue(record.get('period_startdate'));
		var acc=record.get('housinglandlord_name');
		fillLandlordStatement(acc,53,record.get('person_id'),'N');
		}}
	   ,
        stateful: true,
		multiSelect: true,
