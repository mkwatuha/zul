...
$query_Rcd_getbody= "SELECT distinct displaygroup FROM admin_controller ";
	...
	while($count_tbrows=mysql_fetch_array($Rcd_tbody_results)){
      ...
      $displaygroup=$count_tbrows['displaygroup'];
	  
	$onclick="displayFieldConf('".$displaygroup."','".$table_name."','".$table_name."','".$table_field."','"."fielddisplay".$table_name."')";
	
	
  $displaygroupDetails=  "<input  name=\"fielddisplay\" type=\"radio\" value=\"Display tables\" onclick=\"$onclick\" />$displaygroup";
	print"$displaygroupDetails"."&nbsp;";
    }
}

if($action=='infgroups'){
$query_Rcd_getbody= "SELECT distinct tablename,fieldname,infsubgroup,dataformat FROM admin_controller where infgroup='$groupcontrol' ";
...
$onclick="saveControlScreenLoc('infgroup','infsubgroup','$tablename', '$fieldname','$dataformat','fwidth','flenth','showgroupfieldresults','saveControllPosition')";
	$displaygroupDetails=  "<input  name=\"$tablename$fieldname\" type=\"radio\" value=\"Display tables\" onclick=\"$onclick\" />".$_SESSION[$tablename].'  '.$_SESSION[$tablename.$fieldname];
	print"$displaygroupDetails"."&nbsp;<br>";
    }
