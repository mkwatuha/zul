...
echo("</table>");
echo("<table>");
echo("<tr> <td><a href=\"#\"  onclick=\"hideVisibleDiv('access".$displaygroup."')\">Hide</a><input type=\"button\" class=\"savebutton\"    value=\"Save $displaygroup Rgts\"  onclick=\"$saveDisplayaOpts\">");
