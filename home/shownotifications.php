...
echo $searchNotifications;
	 ...
	 $countOpts=1;
			 ...
			 $countOpts++;
			 echo $alert_name.' '.$_SESSION[$tablename].'<br>';
			 echo $alert_name.' '.$_SESSION[$tablename].'<br>';
			 echo $alert_name.' '.$_SESSION[$tablename].'<br>';
			 echo $alert_name.' '.$_SESSION[$tablename].'<br>';
			 echo $alert_name.' '.$_SESSION[$tablename].'<br>';
			 
			 /*echo $alert_name.' '.$_SESSION[$tablename].' '.$groupnotificationhist_id.' '.$effective_date."<a onMouseOver=\"myfillControl('alertNotificatioID','$alert_id'); myfillControl('currentNotificatioID','$groupnotificationhist_id')\" id=\"IdnotficationLInkIDNGS\" href=\"#\" >$alert_name</a>".'<br>';
