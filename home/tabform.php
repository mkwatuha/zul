...
$primarytable=$_GET['t'];
$formview=$_GET['fd'];
$primaryselector=$_GET['pd'];


$formInfo=fillPrimaryData('designer_sview',$formview);
$primarymargins="margin: '10 5 5 5',";
$primarywidth='.65';
$tabbedformwidth='700';
$tabbedformtitle=$formInfo['sview_name'];
$primarysectitle=$formInfo['main_caption'];
$photosectitle='photo';
$photowidth='0.27';
$detailinfo='detailinfo';
$detailinfo=$_POST['displaydiv'];//'showdynamictableview';
$persontype=$_POST['persontype'];

//http://localhost/odkforms/home/tabform.php?t=admin_person%20&fd=1&pd=281
//$detailinfo='dynamicviewdetailinfo';
$photosectitle=false;
//echo $primaryselector;
