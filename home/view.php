...
<html>
	<head>
	   ...
	   <script type="text/javascript" src="../template/functions/menuDisplayGroups.js"></script>
		<script type="text/javascript" src="../template/functions/coreSharedJavascript.js"></script>
		<script language="JavaScript" src="../template/functions/scriptsAJAX.js"></script>
...
echo $_SESSION[$activetablelinked].' view';
...
<div id="editsession"></div>
<div id="container" >
<div class="full_width big">
<div id="options_tab"><p><a href="../<?PHP $myfolder.'/'.$activetablelinked.'.php'; ?>" > Add </a> | <a href="#" > Statement </a>| <a href="../<?PHP $myfolder.'/'.$activetablelinked.'_options.php'; ?>" > Options </a> | <a href="../<?PHP $myfolder.'/'.$activetablelinked.'_pdf.php'; ?>" > PDF </a>&nbsp;|&nbsp;<a href="../home/view.php?token=<?PHP base64_encode($activetablelinked);?>" > View </a>&nbsp;|&nbsp;<a href="#" onClick="displaySubSections('ReloadThis')">Sys Conf </a>|&nbsp;<a href="#" onClick="displayRightsOptions('ReloadThis','primary','NoId')"> User Rights </a></p></div></div>
...
<div id="ReloadThis" style="height:100; width:20; overflow:auto; border:thick; z-index:45">
 </div>
