...
//
//$this->setXY(228,38);
$this->cell(0,3,'INVOICE:              '.$invoiceno.'                 ',0,1,'R');
...
$this->Ln(1);
$this->SetFont('Times','',10);
$this->Rect(10,58,190,20);
$this->Line(105,58,105,78);
//$this->setX(85);
...
$this->cell(30,4,$prvreading,1,0,'C');
$this->cell(35,4,$prevdd,1,0,'C');

$this->cell(30,4,$creading,1,0,'C');
$this->cell(35,4,$cdd,1,0,'C');

$this->cell(30,4,$consumption,1,0,'C');
...
$this->cell(130,20,'','RLB',0,'R');
$this->cell(60,20,'','RLB',1,'R');
...
$this->cell(130,4,'','RL',0,'R');
$this->cell(60,4,'','RL',1,'R');
}
...
$this->cell(60,4,number_format($charges,2),'RLB',1,'R');
...
$this->cell(50,5,'',1,1,'L');
$this->Image('cut.gif',180,192,6,6);
$this->SetFont('Times','B',6);
$this->cell(94,5,'Your Fixed Deposit:',0,0,'L');
$this->cell(70,5,'Receipt Number:',0,0,'L');
$this->cell(50,5,' Receipt Date:',0,1,'L');
$this->Ln(12);
$this->setFont('Times','B',12);
$this->cell(0,3,'NZOIA CLUSTER',0,1,'C');
$this->Ln(8);
$this->setFont('Times','',10);
$this->cell(45,3,'Kitale',0,0,'L');
$this->cell(45,3,'Bungoma',0,0,'C');
$this->cell(45,3,'Webuye',0,0,'C');
$this->cell(55,3,'Kimilili',0,1,'R');
