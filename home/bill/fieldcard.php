...
$this->cell(0,5,'Field Card for Zone:'.$zone.' Walk:'.$walk,'B',1,'C');
$this->Ln(3);
  ...
  $this->cell(25,5,'Date','L',0,'C');
  $this->cell(25,5,'Reading','L',0,'C');
  $this->cell(30,5,'Comments','L',1,'C');
 // $this->cell(20,5,'Cons',0,1,'L');
...
function LoadData()
{
            $zone=3;
            $walk=3;
            $selacc="SELECT DISTINCT autoid FROM property WHERE isactive=1 AND zone=$zone AND walk=$walk ORDER BY zone,block,walk,connectionno";
...
// $cddd=date("d F,Y");
 ...
 $this->cell(24,4,'There was an error accessing accounts details',0,1,'C');
  ...
  $this->cell(25,4,'','L',0,'L',$rw);
  $this->cell(25,4,'','L',0,'L',$rw);
  $this->cell(30,4,'','L',1,'L',$rw);
  //$this->cell(20,4,$consumption,0,1,'L',$rw);
