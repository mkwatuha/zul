...
gridwidth,gridhieght,formheight,orderpos,created_by,date_created,changed_by,date_changed,voided,voided_by,date_voided,uuid,sys_track) 

values('$table_id',
'$table_name','$table_caption',
'$table_caption','$flexcolumn',
'$gridwidth','$gridhieght','$formheight','$orderpos','$created_by','$date_created','$changed_by','$date_changed','$voided','$voided_by','$date_voided','$uuid','$status')";
...
//set standard inform
 ...
 $sqladminStd="Select * from admin_controller where tablename='accounts_invoiceitems' ";   
			...
			$sqlHideMultiplecols="update admin_controller set pdfvisible='Hide',detailsvisiblepdf='Hide', infshow='Hide' where ucase(fieldname ) in ('SYS_TRACK','CREATED_BY','DATE_CREATED','CHANGED_BY','DATE_CHANGED','VOIDED','VOIDED_BY','DATE_VOIDED','UUID','DELETED') "; 
